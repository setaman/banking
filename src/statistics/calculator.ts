import { StatsI, TransactionI, TransactionsGroupI } from "../types";
...
export function groupTransactionByDay(
...
export const calculateTransactionsStats = (
  transactions: TransactionI[]
): StatsI => {
  return {
    ...
    transactionsGroupByMonth: groupTransactionByDate(transactions),
    transactionsGroupByDay: groupTransactionByDay(transactions),
  };
};
