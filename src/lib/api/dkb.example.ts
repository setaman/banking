 ...
 * Token is NEVER stored - only passed as parameter and discarded.
 */

import { fetchAllTransactions } from './dkb';
 ...
 * pastes their DKB bearer token.
 * 
 * @param bearerToken - Token pasted by user (stored only in memory)
